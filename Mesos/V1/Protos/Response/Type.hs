...
module Mesos.V1.Protos.Response.Type (Type(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum Type where
  ...
  toEnum
   = P'.fromMaybe (Prelude'.error "hprotoc generated code: toEnum failure for type Mesos.V1.Protos.Response.Type") . toMaybe'Enum
  succ UNKNOWN = RECONCILE_OPERATIONS
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type Mesos.V1.Protos.Response.Type"
  pred RECONCILE_OPERATIONS = UNKNOWN
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type Mesos.V1.Protos.Response.Type"
...
instance P'.ReflectEnum Type where
  ...
  reflectEnumInfo _
   = P'.EnumInfo (P'.makePNF (P'.pack ".mesos.v1.scheduler.Response.Type") ["Mesos", "V1"] ["Protos", "Response"] "Type")
      ["Mesos", "V1", "Protos", "Response", "Type.hs"]
