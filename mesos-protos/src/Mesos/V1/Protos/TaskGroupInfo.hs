...
module Mesos.V1.Protos.TaskGroupInfo (TaskGroupInfo(..), tasks) where
import Prelude ((+), (/), (++), (.))
...
data TaskGroupInfo = TaskGroupInfo{_tasks :: !(P'.Seq Protos.TaskInfo)}
                     deriving (Prelude'.Show, Prelude'.Eq, Prelude'.Ord, Prelude'.Typeable, Prelude'.Data, Prelude'.Generic)

Control.Lens.TH.makeLenses ''TaskGroupInfo
