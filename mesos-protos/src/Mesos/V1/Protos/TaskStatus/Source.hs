...
instance P'.FromJSON Source where
  parseJSON
   = P'.withText "Mesos.V1.Protos.TaskStatus.Source.Source"
      (\ msg' ->
        case msg' of
          "SOURCE_MASTER" -> Prelude'.return SOURCE_MASTER
          "SOURCE_AGENT" -> Prelude'.return SOURCE_AGENT
          "SOURCE_EXECUTOR" -> Prelude'.return SOURCE_EXECUTOR
          _ -> Prelude'.fail
                ("Invalid value " Prelude'.++ Prelude'.show msg' Prelude'.++ " for enum Mesos.V1.Protos.TaskStatus.Source.Source"))