...
module Mesos.V1.Protos.FrameworkInfo.Capability (Capability(..), type') where
import Prelude ((+), (/), (++), (.))
...
data Capability = Capability{_type' :: !(P'.Maybe Protos.FrameworkInfo.Capability.Type)}
