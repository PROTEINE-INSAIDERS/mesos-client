...
data CheckStatusInfo = CheckStatusInfo{type' :: !(P'.Maybe Protos.CheckInfo.Type),
                                       ...
                                       http :: !(P'.Maybe Protos.CheckStatusInfo.Http),
                                       tcp :: !(P'.Maybe Protos.CheckStatusInfo.Tcp)}
   ...
   = P'.withObject "CheckStatusInfo"
      (\ o ->
        do
          ...
          Prelude'.return P'.defaultValue{type' = type', command = command, http = http, tcp = tcp})
