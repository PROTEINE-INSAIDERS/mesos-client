...
instance P'.ToJSON OperationState where
  toJSON msg'
   = P'.String
      (case msg' of
         ...
         OPERATION_DROPPED -> "OPERATION_DROPPED"
         OPERATION_UNREACHABLE -> "OPERATION_UNREACHABLE"
         OPERATION_GONE_BY_OPERATOR -> "OPERATION_GONE_BY_OPERATOR"
         OPERATION_RECOVERING -> "OPERATION_RECOVERING"
         OPERATION_UNKNOWN -> "OPERATION_UNKNOWN")

instance P'.FromJSON OperationState where
  parseJSON
   = P'.withText "Mesos.V1.Protos.OperationState.OperationState"
      (\ msg' ->
        case msg' of
          "OPERATION_UNSUPPORTED" -> Prelude'.return OPERATION_UNSUPPORTED
          "OPERATION_PENDING" -> Prelude'.return OPERATION_PENDING
          "OPERATION_FINISHED" -> Prelude'.return OPERATION_FINISHED
          "OPERATION_FAILED" -> Prelude'.return OPERATION_FAILED
          "OPERATION_ERROR" -> Prelude'.return OPERATION_ERROR
          "OPERATION_DROPPED" -> Prelude'.return OPERATION_DROPPED
          "OPERATION_UNREACHABLE" -> Prelude'.return OPERATION_UNREACHABLE
          "OPERATION_GONE_BY_OPERATOR" -> Prelude'.return OPERATION_GONE_BY_OPERATOR
          "OPERATION_RECOVERING" -> Prelude'.return OPERATION_RECOVERING
          "OPERATION_UNKNOWN" -> Prelude'.return OPERATION_UNKNOWN
          _ -> Prelude'.fail
                ("Invalid value " Prelude'.++ Prelude'.show msg' Prelude'.++
                  " for enum Mesos.V1.Protos.OperationState.OperationState"))