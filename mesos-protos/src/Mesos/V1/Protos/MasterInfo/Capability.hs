...
module Mesos.V1.Protos.MasterInfo.Capability (Capability(..)) where
import Prelude ((+), (/), (++), (.))
...
data Capability = Capability{type' :: !(P'.Maybe Protos.MasterInfo.Capability.Type)}
