...
module Mesos.V1.Protos.DomainInfo.FaultDomain.RegionInfo (RegionInfo(..), name) where
import Prelude ((+), (/), (++), (.))
...
data RegionInfo = RegionInfo{_name :: !(P'.Utf8)}
                  deriving (Prelude'.Show, Prelude'.Eq, Prelude'.Ord, Prelude'.Typeable, Prelude'.Data, Prelude'.Generic)

Control.Lens.TH.makeLenses ''RegionInfo
