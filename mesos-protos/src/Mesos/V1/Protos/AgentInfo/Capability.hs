...
module Mesos.V1.Protos.AgentInfo.Capability (Capability(..), type') where
import Prelude ((+), (/), (++), (.))
...
data Capability = Capability{_type' :: !(P'.Maybe Protos.AgentInfo.Capability.Type)}
