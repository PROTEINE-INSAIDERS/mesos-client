   ...
   = P'.withObject "NetworkInfo"
      (\ o ->
        do
          ...
          Prelude'.return
           P'.defaultValue{ip_addresses = ip_addresses, name = name, groups = groups, labels = labels,
