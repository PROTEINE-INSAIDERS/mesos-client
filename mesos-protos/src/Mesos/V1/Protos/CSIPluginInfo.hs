   ...
   = P'.withObject "CSIPluginInfo"
      (\ o ->
        do
          ...
          Prelude'.return P'.defaultValue{type' = type', name = name, containers = containers})
