...
module Mesos.V1.Protos.Flag (Flag(..), name, value) where
import Prelude ((+), (/), (++), (.))
...
data Flag = Flag{_name :: !(P'.Utf8), _value :: !(P'.Maybe P'.Utf8)}
            deriving (Prelude'.Show, Prelude'.Eq, Prelude'.Ord, Prelude'.Typeable, Prelude'.Data, Prelude'.Generic)

Control.Lens.TH.makeLenses ''Flag
