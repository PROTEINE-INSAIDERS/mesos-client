...
module Mesos.V1.Executor.Protos.Call.Message (Message(..), data') where
import Prelude ((+), (/), (++), (.))
...
data Message = Message{_data' :: !(P'.ByteString)}
