   ...
   = P'.withObject "Call"
      (\ o ->
        do
          ...
          Prelude'.return
           P'.defaultValue{executor_id = executor_id, framework_id = framework_id, type' = type', subscribe = subscribe,
