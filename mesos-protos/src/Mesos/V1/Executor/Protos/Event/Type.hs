  ...
  reflectEnumInfo _
   = P'.EnumInfo (P'.makePNF (P'.pack ".mesos.v1.executor.Event.Type") ["Mesos", "V1", "Executor"] ["Protos", "Event"] "Type")
      ...
      [(0, "UNKNOWN"), (1, "SUBSCRIBED"), (2, "LAUNCH"), (8, "LAUNCH_GROUP"), (3, "KILL"), (4, "ACKNOWLEDGED"), (5, "MESSAGE"),
       (6, "ERROR"), (7, "SHUTDOWN"), (9, "HEARTBEAT")]
      Prelude'.True
...
instance P'.FromJSON Type where
  parseJSON
   = P'.withText "Mesos.V1.Executor.Protos.Event.Type.Type"
      (\ msg' ->
        case msg' of
          ...
          "ACKNOWLEDGED" -> Prelude'.return ACKNOWLEDGED
          ...
          _ -> Prelude'.fail
                ("Invalid value " Prelude'.++ Prelude'.show msg' Prelude'.++ " for enum Mesos.V1.Executor.Protos.Event.Type.Type"))