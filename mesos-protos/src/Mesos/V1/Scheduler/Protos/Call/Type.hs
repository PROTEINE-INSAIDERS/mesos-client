...
module Mesos.V1.Scheduler.Protos.Call.Type (Type(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum Type where
  ...
  toEnum
   = P'.fromMaybe (Prelude'.error "hprotoc generated code: toEnum failure for type Mesos.V1.Scheduler.Protos.Call.Type") .
      toMaybe'Enum
  ...
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type Mesos.V1.Scheduler.Protos.Call.Type"
  ...
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type Mesos.V1.Scheduler.Protos.Call.Type"
...
instance P'.ReflectEnum Type where
  ...
  reflectEnumInfo _
   = P'.EnumInfo (P'.makePNF (P'.pack ".mesos.v1.scheduler.Call.Type") ["Mesos", "V1", "Scheduler"] ["Protos", "Call"] "Type")
      ["Mesos", "V1", "Scheduler", "Protos", "Call", "Type.hs"]
...
instance P'.FromJSON Type where
  parseJSON
   = P'.withText "Mesos.V1.Scheduler.Protos.Call.Type.Type"
      (\ msg' ->
        case msg' of
          "UNKNOWN" -> Prelude'.return UNKNOWN
          "SUBSCRIBE" -> Prelude'.return SUBSCRIBE
          "TEARDOWN" -> Prelude'.return TEARDOWN
          "ACCEPT" -> Prelude'.return ACCEPT
          "DECLINE" -> Prelude'.return DECLINE
          "ACCEPT_INVERSE_OFFERS" -> Prelude'.return ACCEPT_INVERSE_OFFERS
          "DECLINE_INVERSE_OFFERS" -> Prelude'.return DECLINE_INVERSE_OFFERS
          "REVIVE" -> Prelude'.return REVIVE
          "KILL" -> Prelude'.return KILL
          "SHUTDOWN" -> Prelude'.return SHUTDOWN
          "ACKNOWLEDGE" -> Prelude'.return ACKNOWLEDGE
          "ACKNOWLEDGE_OPERATION_STATUS" -> Prelude'.return ACKNOWLEDGE_OPERATION_STATUS
          "RECONCILE" -> Prelude'.return RECONCILE
          "RECONCILE_OPERATIONS" -> Prelude'.return RECONCILE_OPERATIONS
          "MESSAGE" -> Prelude'.return MESSAGE
          "REQUEST" -> Prelude'.return REQUEST
          "SUPPRESS" -> Prelude'.return SUPPRESS
          _ -> Prelude'.fail
                ("Invalid value " Prelude'.++ Prelude'.show msg' Prelude'.++ " for enum Mesos.V1.Scheduler.Protos.Call.Type.Type"))