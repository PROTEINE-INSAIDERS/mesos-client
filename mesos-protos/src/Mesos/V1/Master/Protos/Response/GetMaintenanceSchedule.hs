...
module Mesos.V1.Master.Protos.Response.GetMaintenanceSchedule (GetMaintenanceSchedule(..), schedule) where
import Prelude ((+), (/), (++), (.))
...
data GetMaintenanceSchedule = GetMaintenanceSchedule{_schedule :: !(Protos.Schedule)}
                              deriving (Prelude'.Show, Prelude'.Eq, Prelude'.Ord, Prelude'.Typeable, Prelude'.Data,
                                        Prelude'.Generic)

Control.Lens.TH.makeLenses ''GetMaintenanceSchedule
