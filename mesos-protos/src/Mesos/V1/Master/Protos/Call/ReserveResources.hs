...
module Mesos.V1.Master.Protos.Call.ReserveResources (ReserveResources(..), agent_id, resources) where
import Prelude ((+), (/), (++), (.))
...
data ReserveResources = ReserveResources{_agent_id :: !(Protos.AgentID), _resources :: !(P'.Seq Protos.Resource)}
                        deriving (Prelude'.Show, Prelude'.Eq, Prelude'.Ord, Prelude'.Typeable, Prelude'.Data, Prelude'.Generic)

Control.Lens.TH.makeLenses ''ReserveResources
