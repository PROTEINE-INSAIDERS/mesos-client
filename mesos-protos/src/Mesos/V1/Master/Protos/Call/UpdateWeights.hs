...
module Mesos.V1.Master.Protos.Call.UpdateWeights (UpdateWeights(..), weight_infos) where
import Prelude ((+), (/), (++), (.))
...
data UpdateWeights = UpdateWeights{_weight_infos :: !(P'.Seq Protos.WeightInfo)}
                     deriving (Prelude'.Show, Prelude'.Eq, Prelude'.Ord, Prelude'.Typeable, Prelude'.Data, Prelude'.Generic)

Control.Lens.TH.makeLenses ''UpdateWeights
