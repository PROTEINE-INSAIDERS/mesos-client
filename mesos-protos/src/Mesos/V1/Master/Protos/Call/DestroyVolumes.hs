...
module Mesos.V1.Master.Protos.Call.DestroyVolumes (DestroyVolumes(..), agent_id, volumes) where
import Prelude ((+), (/), (++), (.))
...
data DestroyVolumes = DestroyVolumes{_agent_id :: !(Protos.AgentID), _volumes :: !(P'.Seq Protos.Resource)}
                      deriving (Prelude'.Show, Prelude'.Eq, Prelude'.Ord, Prelude'.Typeable, Prelude'.Data, Prelude'.Generic)

Control.Lens.TH.makeLenses ''DestroyVolumes
