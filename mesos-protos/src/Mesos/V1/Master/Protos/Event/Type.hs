...
instance P'.FromJSON Type where
  parseJSON
   = P'.withText "Mesos.V1.Master.Protos.Event.Type.Type"
      (\ msg' ->
        case msg' of
          "UNKNOWN" -> Prelude'.return UNKNOWN
          "SUBSCRIBED" -> Prelude'.return SUBSCRIBED
          "TASK_ADDED" -> Prelude'.return TASK_ADDED
          "TASK_UPDATED" -> Prelude'.return TASK_UPDATED
          "AGENT_ADDED" -> Prelude'.return AGENT_ADDED
          "AGENT_REMOVED" -> Prelude'.return AGENT_REMOVED
          "FRAMEWORK_ADDED" -> Prelude'.return FRAMEWORK_ADDED
          "FRAMEWORK_UPDATED" -> Prelude'.return FRAMEWORK_UPDATED
          "FRAMEWORK_REMOVED" -> Prelude'.return FRAMEWORK_REMOVED
          "HEARTBEAT" -> Prelude'.return HEARTBEAT
          _ -> Prelude'.fail
                ("Invalid value " Prelude'.++ Prelude'.show msg' Prelude'.++ " for enum Mesos.V1.Master.Protos.Event.Type.Type"))