...
module Mesos.V1.Master.Protos.Event.AgentRemoved (AgentRemoved(..), agent_id) where
import Prelude ((+), (/), (++), (.))
...
data AgentRemoved = AgentRemoved{_agent_id :: !(Protos.AgentID)}
                    deriving (Prelude'.Show, Prelude'.Eq, Prelude'.Ord, Prelude'.Typeable, Prelude'.Data, Prelude'.Generic)

Control.Lens.TH.makeLenses ''AgentRemoved
