...
data ContainerStatus = ContainerStatus{container_id :: (P'.Maybe Protos.ContainerID), network_infos :: (P'.Seq Protos.NetworkInfo),
                                       cgroup_info :: (P'.Maybe Protos.CgroupInfo), executor_pid :: (P'.Maybe P'.Word32)}
