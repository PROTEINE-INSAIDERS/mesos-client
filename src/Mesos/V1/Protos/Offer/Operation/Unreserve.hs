...
module Mesos.V1.Protos.Offer.Operation.Unreserve (Unreserve(..)) where
import Prelude ((+), (/))
...
data Unreserve = Unreserve{resources :: (P'.Seq Protos.Resource)}
