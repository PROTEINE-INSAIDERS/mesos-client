...
data Value = Value{type' :: (Protos.Value.Type), scalar :: (P'.Maybe Protos.Value.Scalar), ranges :: (P'.Maybe Protos.Value.Ranges),
                   set :: (P'.Maybe Protos.Value.Set), text :: (P'.Maybe Protos.Value.Text)}
