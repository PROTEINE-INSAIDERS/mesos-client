...
module Mesos.V1.Protos.Call.UpdateMaintenanceSchedule (UpdateMaintenanceSchedule(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.V1.Protos.Schedule as Protos (Schedule)
...
instance P'.ReflectDescriptor UpdateMaintenanceSchedule where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.v1.master.Call.UpdateMaintenanceSchedule\", haskellPrefix = [MName \"Mesos\",MName \"V1\"], parentModule = [MName \"Protos\",MName \"Call\"], baseName = MName \"UpdateMaintenanceSchedule\"}, descFilePath = [\"Mesos\",\"V1\",\"Protos\",\"Call\",\"UpdateMaintenanceSchedule.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.v1.master.Call.UpdateMaintenanceSchedule.schedule\", haskellPrefix' = [MName \"Mesos\",MName \"V1\"], parentModule' = [MName \"Protos\",MName \"Call\",MName \"UpdateMaintenanceSchedule\"], baseName' = FName \"schedule\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = True, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.v1.maintenance.Schedule\", haskellPrefix = [MName \"Mesos\",MName \"V1\"], parentModule = [MName \"Protos\"], baseName = MName \"Schedule\"}), hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
