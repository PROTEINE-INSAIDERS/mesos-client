...
module Mesos.V1.Protos.Response.GetMaintenanceStatus (GetMaintenanceStatus(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.V1.Protos.ClusterStatus as Protos (ClusterStatus)
